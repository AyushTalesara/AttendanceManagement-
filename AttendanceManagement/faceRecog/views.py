...
from records.models import student,teacher,subjects,attendances
...
def detect(request):
    ...
    rec.read(BASE_DIR+'/static/ml/recognizer/trainingData.yml')
    getId = 0
